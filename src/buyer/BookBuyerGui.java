 ...
 */
public class BookBuyerGui extends JFrame implements IBookBuyerGui {
...
///////////
        ...
        setDeadlineB.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                if (tc.showEditTimeDlg(BookBuyerGui.this) == TimeChooser.OK) {
                    deadline = tc.getDate();
        ...
        setCCB.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                String cc = JOptionPane.showInputDialog(BookBuyerGui.this, "Insert the Credit Card number");
                if (cc != null && cc.length() > 0) {
                    myAgent.setCreditCard(cc);
                }
                else {
                    JOptionPane.showMessageDialog(BookBuyerGui.this, "Invalid Credit Card number", "WARNING", JOptionPane.WARNING_MESSAGE);
                }
            }
        } );
...
//JOptionPane.showMessageDialog(BookBuyerGui.this, "Max cost must be greater than best cost", "WARNING", JOptionPane.WARNING_MESSAGE);
//}
                            }
                            catch (Exception ex1) {
// Invalid max cost
                                JOptionPane.showMessageDialog(BookBuyerGui.this, "Invalid max cost", "WARNING", JOptionPane.WARNING_MESSAGE);
                            }
                        }
                        catch (Exception ex2) {
// Invalid desired cost
                            JOptionPane.showMessageDialog(BookBuyerGui.this, "Invalid best cost", "WARNING", JOptionPane.WARNING_MESSAGE);
                        }
                    }
                    else {
// No deadline specified
                        JOptionPane.showMessageDialog(BookBuyerGui.this, "Invalid deadline", "WARNING", JOptionPane.WARNING_MESSAGE);
                    }
                }
                else {
// No book title specified
                    JOptionPane.showMessageDialog(BookBuyerGui.this, "No book title specified", "WARNING", JOptionPane.WARNING_MESSAGE);
                }
            }
        } );
